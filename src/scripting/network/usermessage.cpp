...
LoadScriptingComponent(usermessage, [](PluginObject plugin, EContext* ctx) -> void {
    ...
    ADD_CLASS_FUNCTION("UserMessage", "GetBytes", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
        context->SetReturn(data->GetData<UserMessage*>("um_ptr")->GetBytes(field_name));
    });

    ADD_CLASS_FUNCTION("UserMessage", "SetBytes", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
        std::string value = context->GetArgumentOr<std::string>(1, "");
        data->GetData<UserMessage*>("um_ptr")->SetBytes(field_name, value);
    });

    ADD_CLASS_FUNCTION("UserMessage", "GetRepeatedBytes", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
        int index = context->GetArgumentOr<int>(1, 0);
        context->SetReturn(data->GetData<UserMessage*>("um_ptr")->GetRepeatedBytes(field_name, index));
    });

    ADD_CLASS_FUNCTION("UserMessage", "SetRepeatedBytes", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
        int index = context->GetArgumentOr<int>(1, 0);
        std::string value = context->GetArgumentOr<std::string>(2, "");
        data->GetData<UserMessage*>("um_ptr")->SetRepeatedBytes(field_name, index, value);
    });

    ADD_CLASS_FUNCTION("UserMessage", "AddBytes", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
        std::string value = context->GetArgumentOr<std::string>(1, "");
        data->GetData<UserMessage*>("um_ptr")->AddBytes(field_name, value);
    });
    ...
    ADD_CLASS_FUNCTION("UserMessage", "GetMessage", [](FunctionContext* context, ClassData* data) -> void {
        std::string field_name = context->GetArgumentOr<std::string>(0, "");
        if (field_name == "") return;
