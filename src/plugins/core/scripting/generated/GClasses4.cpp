...
GCRegionSVM GRnHull_t::GetRegionSVM() const {
    GCRegionSVM value(*(void**)GetSchemaPtr(m_ptr, "RnHull_t", "m_pRegionSVM"));
    return value;
}
...
void GVMixDynamics3BandDesc_t::SetBandDesc(std::vector<GVMixDynamicsBand_t> value) {
    PLUGIN_PRINT("Schema SDK", "Setting a value for 'BandDesc' is not possible.\n");
}
...
void GAimMatrixOpFixedSettings_t::SetPoseCacheHandles(std::vector<GCPoseHandle> value) {
    PLUGIN_PRINT("Schema SDK", "Setting a value for 'PoseCacheHandles' is not possible.\n");
}
...
GCDecalInfo GCDecalInfo::GetNext() const {
    GCDecalInfo value(*(void**)GetSchemaPtr(m_ptr, "CDecalInfo", "m_pNext"));
    return value;
}
...
GCDecalInfo GCDecalInfo::GetPrev() const {
    GCDecalInfo value(*(void**)GetSchemaPtr(m_ptr, "CDecalInfo", "m_pPrev"));
    return value;
}
...
void GCMovementComponentUpdater::SetParamHandles(std::vector<GCAnimParamHandle> value) {
    PLUGIN_PRINT("Schema SDK", "Setting a value for 'ParamHandles' is not possible.\n");
}
...
GCNewParticleEffect GCNewParticleEffect::GetNext() const {
    GCNewParticleEffect value(*(void**)GetSchemaPtr(m_ptr, "CNewParticleEffect", "m_pNext"));
    return value;
}
...
GCNewParticleEffect GCNewParticleEffect::GetPrev() const {
    GCNewParticleEffect value(*(void**)GetSchemaPtr(m_ptr, "CNewParticleEffect", "m_pPrev"));
    return value;
}
...
GIParticleCollection GCNewParticleEffect::GetParticles() const {
    GIParticleCollection value(*(void**)GetSchemaPtr(m_ptr, "CNewParticleEffect", "m_pParticles"));
    return value;
}
...
GPARTICLE_EHANDLE__ GCNewParticleEffect::GetOwner() const {
    GPARTICLE_EHANDLE__ value(*(void**)GetSchemaPtr(m_ptr, "CNewParticleEffect", "m_hOwner"));
    return value;
}
...
GCParticleProperty GCNewParticleEffect::GetOwningParticleProperty() const {
    GCParticleProperty value(*(void**)GetSchemaPtr(m_ptr, "CNewParticleEffect", "m_pOwningParticleProperty"));
    return value;
}
...
GRnHull_t GCastSphereSATParams_t::GetHull() const {
    GRnHull_t value(*(void**)GetSchemaPtr(m_ptr, "CastSphereSATParams_t", "m_pHull"));
    return value;
}
...
GCEntityComponentHelper GEntComponentInfo_t::GetBaseClassComponentHelper() const {
    GCEntityComponentHelper value(*(void**)GetSchemaPtr(m_ptr, "EntComponentInfo_t", "m_pBaseClassComponentHelper"));
    return value;
}
...
GCRenderGroom GCRenderMesh::GetGroomData() const {
    GCRenderGroom value(*(void**)GetSchemaPtr(m_ptr, "CRenderMesh", "m_pGroomData"));
    return value;
}
