...
const GenerateLuaType = (param) => {
    ...
    else if (param == "uint32_t" || param == "uint16_t" || param == "uint64_t" || param == "int" || param == "uint8_t" || param == "unsigned short" || param == "unsigned long long" || param == "short" || param == "long" || param == "float" || param == "unsigned char" || param == "Weapon*") return "number";
