...
${lang != "cs" ? GenerateFunctionReturn("EventResult", lang) : ""}${lang == "lua" ? `--- @event returns ${GenerateType(pageContent.return, lang)} via event:SetReturn\n` : ""}${lang == "cs" ? "Events." : ""}AddEventHandler("${pageContent.event_name}", ${lang == "lua" ? "function" : ""}(${ProcessFunctionParameters(pageContent.mode == "core" ? { [lang == "cs" ? "@event" : "event"]: lang == "cs" ? "Events.Event" : "Event", ...pageContent.arguments } : { [lang == "cs" ? "@event" : "event"]: lang == "cs" ? "Events.Event" : "Event" }, lang)})${lang == "lua" ? "" : " => {"}
    ${lang == "lua" ? "-- [[...]]" : "// ..."}
